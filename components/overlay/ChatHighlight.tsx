...
import { ChatHighlight as ChatHighlightType, ChatHighlightLayout } from '@/types/overlay';
...
export default function ChatHighlight({ highlight, layout }: ChatHighlightProps) {
      ...
      >
        ...
        <div className='flex items-start gap-4 relative z-10'>
          <div className='flex-shrink-0'>
            <div className='text-4xl mb-2 animate-bounce-gentle'>{roleIcons[message.role]}</div>
